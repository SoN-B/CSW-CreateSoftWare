...
Monster Slime_Elite = { "가시 슬라임","elite",150,0,30,7.5,1.5 ,82.5,80,0 };
Monster* Slime_Elite_P = &Slime_Elite;
Monster Slime_Boss = { "킹 슬라임","boss",200,0,40,10,2 ,110,120,0 };
Monster* Slime_Boss_P = &Slime_Boss;

Monster Goblin_Normal = { "고블린","normal",120,0,30,8,1.2,70,60,0 };
Monster* Goblin_Normal_P = &Goblin_Normal;
Monster Goblin_Elite = { "핏빛 고블린","elite",180,0,45,12,1.8,105,80,0 };
Monster* Goblin_Elite_P = &Goblin_Elite;
Monster Goblin_Boss = { "고블린 킹","boss",240,0,60,16,2.4 ,140,150,0 };
Monster* Goblin_Boss_P = &Goblin_Boss;

Monster Orc_Normal = { "오크","normal",150,0,50,12,1.5 ,95,90,0 };
Monster* Orc_Normal_P = &Orc_Normal;
Monster Orc_Elite = { "광란의 오크","normal",225,0,75,18,2.25 ,130,110,0 };
